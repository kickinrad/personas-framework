...
and recovery evidence. The retained source ref is `forge/personas-mesh-extraction` at
`e1f504222883b0fb5823f6cbec2b2305336dbdd4`. This is a recovery record, not a
Mesh installation or runtime instruction.
